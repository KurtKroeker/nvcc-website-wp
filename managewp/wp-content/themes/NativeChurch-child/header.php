...
<?php if ($options['switch-responsive'] == 1) { ?>
	...
	date_default_timezone_set($offset);
        ...
        <?php //  WORDPRESS HEAD HOOK 
         wp_head(); 
         ?>
         <script src="<?php echo home_url(); ?>/wp-content/themes/NativeChurch-child/js/nvcc.js"></script>
    </head>
    <!--// CLOSE HEAD //-->
...
//                <!-- Start Top Row -->
            ...
            <header class="site-header">
                <div class="topbar">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-sm-8 col-xs-12" id="nvcc-mini-menu">
                                <h1 class="logo">
                                    <?php
                                    global $imic_options;
                            ...
                            if (!empty($options['header_layout'])):
                                echo '<div class="col-md-8 col-sm-6 col-xs-4" id="nvcc-hamburger">';
                                if ($options['header_layout'] != 3):
                                    if (!empty($menu_locations['top-menu'])):
